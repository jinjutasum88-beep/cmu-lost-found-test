...
const DICT = {
  th: {
    ...
    /* ---------- หน้าแรกสาธารณะ ---------- */
    "public.login": "เข้าสู่ระบบ",
    "public.signup": "สมัครสมาชิก",
    "public.back": "← กลับหน้าแรก",
    "public.kicker": "✦ CMU LOST&FOUND",
    "public.title1": "ทุกของหาย",
    "public.title2": "มีโอกาสได้คืน",
    "public.lead": "พื้นที่กลางของชาว CMU ที่ช่วยเชื่อมประกาศของหายกับของที่มีคนเก็บได้ ให้คุณมีโอกาสพบของคืนโดยไม่ต้องไล่ค้นหาทุกประกาศด้วยตัวเอง",
    "public.start": "เริ่มใช้งานด้วยอีเมล CMU",
    "public.howButton": "ดูวิธีใช้งาน",
    "public.cmuOnly": "สำหรับนักศึกษาและบุคลากรมหาวิทยาลัยเชียงใหม่",
    "public.boardAria": "ตัวอย่างกระดานประกาศของหายและของพบ",
    "public.matched": "จับคู่แล้ว",
    "public.card1Title": "กระเป๋าสตางค์สีดำ",
    "public.card1Detail": "บริเวณอาคารเรียนรวม · 9 ก.ย. 2569",
    "public.card2Title": "กุญแจห้อง 2 ดอก",
    "public.card2Detail": "มีพวงกุญแจสีม่วง · พบใกล้โรงอาหาร",
    "public.card3Title": "หูฟังสีขาว",
    "public.card3Detail": "ระบบพบรายการที่คล้ายกัน 86%",
    "public.card4Title": "บัตรนักศึกษา",
    "public.card4Detail": "หายระหว่างทางไปหอสมุด",
    "public.howTitle": "จากประกาศ สู่โอกาสได้คืน",
    "public.howLead": "ทำงานเป็นขั้นตอนง่าย ๆ โดยไม่ต้องค้นหาประกาศทั้งหมดด้วยตัวเอง",
    "public.step1": "บอกรายละเอียด สี สถานที่ และวันที่ของสิ่งของที่หายหรือพบ",
    "public.step2": "กรองหมวดหมู่และสี แล้ววิเคราะห์คำอธิบายเพื่อค้นหารายการใกล้เคียง",
    "public.step3": "ตรวจสอบคู่ที่ระบบแนะนำ ยืนยัน และดูจุดรับของหรือโน้ตจากผู้พบ",
    "public.trustTitle": "พื้นที่ที่ออกแบบเพื่อชาว CMU",
    "public.trustLead": "ทุกบัญชีต้องยืนยันอีเมลมหาวิทยาลัยก่อนใช้งาน เพื่อช่วยให้การลงประกาศและติดต่อรับคืนมีความน่าเชื่อถือขึ้น",
    "public.trust1": "✓ ยืนยันด้วยอีเมล @cmu.ac.th",
  ...
  en: {
    ...
    "public.kicker": "✦ CMU LOST&FOUND",
    "public.title1": "Every lost item",
    "public.title2": "has a chance to return",
    "public.lead": "A shared space for the CMU community that connects lost-item posts with items others have found, so you do not have to search through every post yourself.",
    "public.start": "Continue with a CMU email",
    "public.howButton": "How it works",
    "public.cmuOnly": "For Chiang Mai University students and staff",
    "public.boardAria": "Sample lost-and-found notice board",
    "public.matched": "Matched",
    "public.card1Title": "Black wallet",
    "public.card1Detail": "General classroom building · 9 Sep 2026",
    "public.card2Title": "Two room keys",
    "public.card2Detail": "Purple keyring · found near the canteen",
    "public.card3Title": "White earphones",
    "public.card3Detail": "The system found an 86% similar post",
    "public.card4Title": "Student ID card",
    "public.card4Detail": "Lost on the way to the library",
    "public.howTitle": "From a post to a possible return",
    "public.howLead": "A simple process without searching every post yourself",
    "public.step1": "Add the details, colour, location, and date of the item you lost or found.",
    "public.step2": "Filter by category and colour, then analyse descriptions to find similar posts.",
    "public.step3": "Review a suggested match, confirm it, and view the pickup point or finder's note.",
    "public.trustTitle": "A space designed for the CMU community",
    "public.trustLead": "Every account must verify a university email before use, making posts and return arrangements more trustworthy.",
    "public.trust1": "✓ Verified with a @cmu.ac.th email",
